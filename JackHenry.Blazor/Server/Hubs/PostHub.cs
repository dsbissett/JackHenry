...
namespace JackHenry.Blazor.Server.Hubs
{
    public interface IPostHub
    {
        // Marker interface for temporarily starting reddit stream
        void Noop();
    }
    ...
    public class PostHub : Hub<IPostClient>, IPostHub
    {
        ...
        public async void Noop()
        {
            //await Task.WhenAll(this.UpdatePostCount());
        }
